...
const BRIDGE_SOURCE_FILES = Object.freeze([
  ...
  "src/bridge-maintenance.js", "src/bridge-problem-copy.js", "src/canvas-classic-quiz-submission-read.js", "src/canvas-content.js", "src/canvas-conversations.js", "src/canvas-course-summary-read.js", "src/canvas-file-content.js",
  "src/canvas-file-signals.js", "src/canvas-file-transfer.js", "src/canvas-operation-readback.js", "src/canvas-write-outcome.js", "src/course-connection-intent.js", "src/course-data-consent.js", "src/edit-policy.js", "src/item-bank-executor.js", "src/item-bank-fan-out.js", "src/item-bank-frames.js", "src/item-bank-guard.js",
  ...
  "src/moodle-scorm-report-read.js", "src/moodle-section-executor.js", "src/moodle-site-inventory-read.js", "src/moodle-subsection-executor.js", "src/moodle-workshop-executor.js", "src/new-quiz-item-guard.js", "src/new-quiz-write-contract.js", "src/quiz-item-payload.js", "src/service-worker.js", "src/verification.js"
]);
...
async function preparePayload(target, destination, replace) {
  ...
  try {
    ...
    const receipt = {
      ...
      target,
      payload: destination,
      node: { version: NODE_VERSION, archive: TARGETS[target].archive, sha256: TARGETS[target].sha256 },
      source: {
        ...checkpoint,
