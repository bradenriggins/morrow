...
if ($registryAfterUpgrade[0].publisher -ne 'Braden Riggins' -or $registryAfterUpgrade[0].displayName -ne 'Morrow 1.0.3' -or $registryAfterUpgrade[0].displayVersion -ne '1.0.3') {
