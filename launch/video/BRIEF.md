...
language: en
length: 33.1s
angle: trustworthy-course-work
narration: no
style_preset: graphite-violet
---
...
- `assets/morrow-wordmark-dark.png` — original Morrow colored orbit and white wordmark.
...
- Use white paper, cool-neutral surfaces, graphite ink, and the `#4931aa`
  accent. Use the original wordmark unchanged.
