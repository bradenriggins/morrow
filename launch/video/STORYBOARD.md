...
action color. Use Google Sans Flex and the original Morrow wordmarks unchanged.
The course-work packet is the continuous visual subject. It moves through every
phase, so each step causes the next action. Use one paused GSAP timeline,
...
- status: animated
- src: index.html#phase-intro
- duration: 4.1s
- transition_in: cut
- scene: Morrow introduces a reviewable course-work flow.
- asset_candidates: assets/morrow-wordmark.png

Move course work forward. Stay in control. enters beside the first visible
course-work packet. The supporting caption explains that Morrow helps prepare
and carry out lesson, quiz, and course changes with the user's assistant, then
holds that Morrow is where the work is reviewed. The packet is not a live
course record.

## Frame 2 — Apply with control

- status: animated
- src: index.html#phase-apply
- duration: 5.5s
- transition_in: connected handoff
- scene: The course-work packet stops at an approval gate.

The packet stops before three violet review bars. The heading states Review
before you approve. The caption states See exactly what will change in your
course. Approve presses once. The waiting caption disappears on the same frame
as approval. The bars lift and the packet moves on. The gate caption leaves
before the packet crosses its area.

## Frame 3 — Verify the saved work

- status: animated
- src: index.html#phase-verify
- duration: 5.7s
- transition_in: connected handoff
...
- status: animated
- src: index.html#phase-close
- duration: 5.2s
- transition_in: right-to-left field push
- scene: The course-work packet reaches the final Morrow promise.
- asset_candidates: assets/morrow-wordmark-dark.png

The dark field carries the outgoing stage off screen. The original dark
wordmark and Move course work forward. Stay in control. settle beside the same
packet. The four exact pillar labels form two aligned rows: Review before you
approve, Know what was saved, Keep your sign-in private, and Choose how you
work. The final state holds through 33.1 seconds.
