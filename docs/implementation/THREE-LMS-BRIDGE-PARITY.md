...
The website and film must reflect these limits. The source and connector packages at checkpoint `146d55fc5` passed exact-byte comparison and fresh-folder installation on this Mac. That package predates the section visibility correction. Final matching packages and independent release evidence remain pending; public deployment and project completion still require the full acceptance criteria.
