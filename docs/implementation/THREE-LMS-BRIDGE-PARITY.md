...
The Moodle catalog now has 29 operations: fifteen reads and fourteen writes. It covers course discovery and settings, course structure, hidden Page, Assignment and Quiz creation, section text, activity settings, dates, and visibility. Operation counts describe implementation breadth. They do not prove parity or live support for every operation.
...
| Build course structure | Read structure; place a new hidden Page, Assignment, or Quiz in a selected section; edit section text; show or hide sections and activities. | One two-Page section hide/show workflow is confirmed. Reorder structure and live-check other supported writes. |
