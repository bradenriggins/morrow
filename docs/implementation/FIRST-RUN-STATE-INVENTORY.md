...
| `Apply this change` | Review page | `packages/mcp-server/src/approval-server.ts:956` |
| `Add this question` | Review page | `packages/mcp-server/src/approval-server.ts:956` |
