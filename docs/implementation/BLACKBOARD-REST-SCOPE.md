...
71 tools: 56 reads and 15 writes;
45 are private source tools and 30
...
| `blackboard_plan_course_copy` | course-lifecycle | `GET /learn/api/public/v3/courses/{course_id}?fields=id,courseId,name,ultraStatus,closedComplete,availability` | read | Private source tool | `unknown` | `api_configured_live_untested` |
| `blackboard_apply_reviewed_course_copy` | course-lifecycle | `POST /learn/api/public/v2/courses/{course_id}/copy` | write | Gateway dispatch only | `unknown` | `api_configured_live_untested` |
| `blackboard_verify_course_copy` | course-lifecycle | `GET /learn/api/public/v1/courses/{course_id}/tasks/{task_id}` | read | Gateway dispatch only | `unknown` | `api_configured_live_untested` |
