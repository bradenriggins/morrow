...
export const brandHeader = '<div class="brand"><img src="/morrow-brand/morrow.png" width="38" height="38" alt=""><div><strong>Morrow</strong><span>Canvas operations layer</span></div></div>';
