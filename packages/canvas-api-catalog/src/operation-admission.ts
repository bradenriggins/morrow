...
export type CanvasWriteAdmission =
  ...
  | {
    readonly state: "held";
    readonly reason: "multi_step_upload_requires_reviewed_transfer";
  };
 ...
 */
export function canvasRedirectRead(
  operation: Pick<CanvasApiOperation, "readOnly" | "responseType" | "summary" | "description">,
): boolean {
