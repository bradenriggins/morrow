...
test("the exact pull-request CI command rejects stale generated provider artifacts", () => {
  ...
  assert.match(job("check"), /needs: \[changes, check-repository, check-desktop, check-desktop-windows, check-desktop-macos, check-muse\]/, "the required check aggregates change detection, the repository text gates and every suite");
