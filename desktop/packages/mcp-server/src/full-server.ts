...
import { registerNewQuizItemOrderTool } from "./new-quiz-item-order.js";
import { registerNewQuizSettingsTool } from "./new-quiz-settings.js";
import { registerNewQuizLifecycleTools } from "./new-quiz-lifecycle.js";
import { registerNewQuizEffectTools } from "./new-quiz-effects.js";
...
export function createFullMorrowServer(runtime: MorrowRuntime, context: MorrowServerContext = {}): McpServer {
  ...
  registerNewQuizItemLifecycleTools(server, runtime.gateway, context.workspaceRoot);
  registerNewQuizItemOrderTool(server, runtime.gateway);
  registerNewQuizSettingsTool(server, runtime.gateway);
  registerNewQuizLifecycleTools(server, runtime.gateway);
  registerNewQuizEffectTools(server, runtime.gateway);
