...
| F5 | **Superseded 2026-09-22: Edit is not timed. It stays on until the educator returns the course to Plan, and neither Plan and Edit settings nor a conversation grant sends a length.** Before: Edit lasts one of five fixed times: 30 minutes, 1, 4, 8 or 24 hours. `validEditDuration` refuses all other values. | `src/edit-policy.js:7`, `:666` |
