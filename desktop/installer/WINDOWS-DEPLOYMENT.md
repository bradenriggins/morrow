...
No Windows 1.0.6 or 1.0.7 installer is published. No native Windows 1.0.7 smoke receipt exists. The Windows download remains the published 1.0.5 installer. Every published Windows artifact so far is unsigned. Automatic updates remain disabled. Use the
