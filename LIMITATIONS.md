...
This file maps current limits from `docs/implementation/MORROW-LEGACY-BRIDGE.md` and stop conditions from `docs/implementation/WEEKEND-CONVERGENCE.md`. It also records held-provider limits that already appear in `README.md`, `docs/sources/donor-manifest.json`, and the upstream example files.
...
Stop the branch when any change would do one of these acts. This list comes from `docs/implementation/WEEKEND-CONVERGENCE.md`:
