# WAVE 7 GETS: grading_standards + grading_periods + late_policy + assignment_groups (course 89585)
...
STEP 2:
  ...
  catalog: C-33
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/assignment_groups
...
STEP 3:
  ...
  catalog: C-32
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/assignment_groups/{AG}
  action: navigate (GET), report the body
  only if: {AG} captured; otherwise report "skipped" with the reason and continue
STEP 4:
  op_id: g7-3
  catalog: C-213
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/grading_periods
  action: navigate (GET), report the body
...
STEP 5:
  ...
  catalog: C-212
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/grading_periods/{GP}
  action: navigate (GET), report the body
  only if: {GP} captured; otherwise report "skipped" with the reason and continue
STEP 6:
  op_id: g7-5
  catalog: C-218
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/grading_standards
  action: navigate (GET), report the body
...
STEP 7:
  ...
  catalog: C-217
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/grading_standards/{GS}
  action: navigate (GET), report the body
  only if: {GS} captured; otherwise report "skipped" with the reason and continue
STEP 8:
  op_id: g7-7
  catalog: C-229
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/late_policy
  action: navigate (GET), report the body
