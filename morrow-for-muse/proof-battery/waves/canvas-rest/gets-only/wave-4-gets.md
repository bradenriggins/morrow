# WAVE 4 GETS: classic quizzes + questions + question groups (course 89585)
...
STEP 3:
  ...
  catalog: C-377
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/quizzes/{Q}
  action: navigate (GET), report the body
...
STEP 4:
  ...
  catalog: C-356
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/quizzes/{Q}/questions
  action: navigate (GET), report the body
...
STEP 5:
  ...
  catalog: C-355
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/quizzes/{Q}/questions/{QQ}
  action: navigate (GET), report the body
  only if: {Q} and {QQ} captured; otherwise report "skipped" with the reason and continue
STEP 6:
  op_id: g4-5
  catalog: C-350
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/quizzes/{Q}/groups
  action: navigate (GET), report the body
...
STEP 7:
  ...
  catalog: C-349
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/quizzes/{Q}/groups/{G}
  action: navigate (GET), report the body
  only if: {Q} and {G} captured; otherwise report "skipped" with the reason and continue
