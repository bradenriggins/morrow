# WAVE 15 GETS: new-quiz Canvas REST reads (course 89585)
...
STEP 2:
  ...
  catalog: C-294
  method: GET
  url: https://chcp.instructure.com/api/quiz/v1/courses/89585/quizzes
...
STEP 3:
  ...
  catalog: C-292
  method: GET
  url: https://chcp.instructure.com/api/quiz/v1/courses/89585/quizzes/{NQ}
  action: navigate (GET), report the body
  only if: {NQ} captured; otherwise report "skipped" with the reason and continue
STEP 4:
  op_id: g15-3
  catalog: C-295
  method: GET
  url: https://chcp.instructure.com/api/quiz/v1/courses/89585/quizzes/{NQ}/items
  action: navigate (GET), report the body
...
STEP 5:
  ...
  catalog: C-293
  method: GET
  url: https://chcp.instructure.com/api/quiz/v1/courses/89585/quizzes/{NQ}/items/{NI}
  action: navigate (GET), report the body
  only if: {NQ} and {NI} captured; otherwise report "skipped" with the reason and continue
STEP 6:
  op_id: g15-5
  catalog: C-291
  method: GET
  url: https://chcp.instructure.com/api/quiz/v1/courses/89585/quizzes/{NQ}/items/media_upload_url
  action: navigate (GET), report the body
  only if: {NQ} captured; otherwise report "skipped" with the reason and continue
