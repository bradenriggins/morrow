# WAVE 13 GETS: ai_experiences (course 89585)
...
STEP 2:
  ...
  catalog: C-12
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/ai_experiences
...
STEP 3:
  ...
  catalog: C-14
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/ai_experiences/{AE}
  action: navigate (GET), report the body
  only if: {AE} captured; otherwise report "skipped" with the reason and continue
STEP 4:
  op_id: g13-3
  catalog: C-15
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/ai_experiences/{AE}/edit
...
STEP 5:
  ...
  catalog: C-16
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/ai_experiences/new
  action: navigate (GET), report the body (note: this endpoint returns an HTML form page, not JSON; report the first 500 chars of the HTML)
