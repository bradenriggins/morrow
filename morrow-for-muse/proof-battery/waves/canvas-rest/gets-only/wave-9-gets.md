# WAVE 9 GETS: calendar_events + blackout_dates (course 89585)
...
STEP 2:
  ...
  catalog: C-55
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/blackout_dates
...
STEP 3:
  ...
  catalog: C-54
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/blackout_dates/{B}
  action: navigate (GET), report the body
  only if: {B} captured; otherwise report "skipped" with the reason and continue
STEP 4:
  op_id: g9-3
  catalog: C-56
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/blackout_dates/new
  action: navigate (GET), report the body (note: this endpoint returns an HTML form page, not JSON; report the first 500 chars of the HTML)
STEP 5:
  op_id: g9-4
  catalog: C-75
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/calendar_events/timetable
  action: navigate (GET), report the body
