# WAVE 6 GETS: outcomes + outcome_groups + proficiency (course 89585)
...
STEP 2:
  ...
  catalog: C-309
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/root_outcome_group
...
STEP 3:
  ...
  catalog: C-304
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_groups
  action: navigate (GET), report the body
STEP 4:
  op_id: g6-3
  catalog: C-305
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_group_links
  action: navigate (GET), report the body
STEP 5:
  op_id: g6-4
  catalog: C-310
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_groups/{RG}
  action: navigate (GET), report the body
  only if: {RG} captured; otherwise report "skipped" with the reason and continue
STEP 6:
  op_id: g6-5
  catalog: C-308
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_groups/{RG}/subgroups
  action: navigate (GET), report the body
  only if: {RG} captured; otherwise report "skipped" with the reason and continue
STEP 7:
  op_id: g6-6
  catalog: C-307
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_groups/{RG}/outcomes
  action: navigate (GET), report the body
  only if: {RG} captured; otherwise report "skipped" with the reason and continue
STEP 8:
  op_id: g6-7
  catalog: C-322
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_alignments
  action: navigate (GET), report the body
STEP 9:
  op_id: g6-8
  catalog: C-341
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/outcome_proficiency
  action: navigate (GET), report the body
