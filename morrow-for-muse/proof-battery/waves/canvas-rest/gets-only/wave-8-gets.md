# WAVE 8 GETS: sections + groups + group_categories (course 89585)
...
STEP 2:
  op_id: g8-anchor-sections
  catalog: C-400 equiv (proven tonight as w1a-sections; ID capture only, not a proof claim) (ANCHOR: already live-proven; ID capture only, not a proof claim)
  method: GET
...
STEP 3:
  ...
  catalog: C-399
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/sections/{S}
  action: navigate (GET), report the body
  only if: {S} captured; otherwise report "skipped" with the reason and continue
STEP 4:
  op_id: g8-2
  catalog: C-225
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/group_categories
  action: navigate (GET), report the body
...
STEP 5:
  ...
  catalog: C-227
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/groups
  action: navigate (GET), report the body
STEP 6:
  op_id: g8-4
  catalog: C-222
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/group_categories/export_tags
  action: navigate (GET), report the body
...
STEP 7:
  ...
  catalog: C-223
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/group_categories/differentiation_tag_candidate_count
  action: navigate (GET), report the body
  PROBE: record the status and body honestly; a 4xx here is a valid result
STEP 8:
  op_id: g8-6
  catalog: C-226
  method: GET
  url: https://chcp.instructure.com/api/v1/courses/89585/bulk_user_tags
  action: navigate (GET), report the body
  PROBE: record the status and body honestly; a 4xx here is a valid result
