...
AUTHORIZATION = (
    ...
    "2026-09-20 tasking: the bundled file:// form-host failed in the managed "
    "browser (browser-process crash, op 24c04681), so prove the connector-"
    "bundled ephemeral localhost form-host fallback through the actual "
    "two-phase product dispatch/complete."
)
...
WRITE_ENTRY = {
    ...
    "extra": {
        "body": {"assignment": {"name": "Morrow Localhost Proof (temp)",
                                "published": False}},
        "verify": {
            "method": "GET",
