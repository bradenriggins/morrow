...
# HISTORICAL RECORD (2026-09-20 live product proof). The first-party
# static relay page cited in AUTHORIZATION below was taken down
# 2026-09-21 and the form lane retired; this file is kept as the record
# of the 2026-09-20 proof only. Do not rerun it against the retired
# relay page.
#
...
# The Morrow PM's 2026-09-20 tasking directed proving the deployed
# first-party static relay page through the actual two-phase
# dispatch/complete.
AUTHORIZATION = (
    ...
    "2026-09-20 tasking to prove the deployed first-party static relay "
    "page through the actual two-phase dispatch/complete."
)
