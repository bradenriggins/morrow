...
Catalog under test: the merged 86-entry catalog (53 canonical inventory
...
def main():
    ...
    _check(len(catalog.entries) == 86,
           "expected 86 merged entries, got %d" % len(catalog.entries))
