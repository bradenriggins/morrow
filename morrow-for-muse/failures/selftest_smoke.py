...
Catalog under test: the merged 87-entry catalog (53 canonical inventory
...
def main():
    ...
    _check(len(catalog.entries) == 87,
           "expected 87 merged entries, got %d" % len(catalog.entries))
