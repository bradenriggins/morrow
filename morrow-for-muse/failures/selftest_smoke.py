...
Catalog under test: the merged 92-entry catalog (53 canonical inventory
...
local-input-refusal mode + 1 never-dispatch mode),
...
def main():
    ...
    _check(len(catalog.entries) == 92,
           "expected 92 merged entries, got %d" % len(catalog.entries))
