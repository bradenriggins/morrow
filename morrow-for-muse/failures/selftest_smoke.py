...
Catalog under test: the merged 91-entry catalog (53 canonical inventory
...
def main():
    ...
    _check(len(catalog.entries) == 91,
           "expected 91 merged entries, got %d" % len(catalog.entries))
