...
Catalog under test: the merged 96-entry catalog (53 canonical inventory
...
course-roster mode + 3 Canvas refusal modes: not permitted, not found,
and any other refused request),
...
def main():
    ...
    _check(len(catalog.entries) == 96,
           "expected 96 merged entries, got %d" % len(catalog.entries))
