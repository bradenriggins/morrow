...
Catalog under test: the merged 99-entry catalog (53 canonical inventory
...
for the helper browser and Item Banks),
...
def main():
    ...
    _check(len(catalog.entries) == 99,
           "expected 99 merged entries, got %d" % len(catalog.entries))
